...
public class IssuePaymentHandler(IContractRepository _contractRepository)
    : IRequestHandler<IssuePaymentCommand, IssuePaymentResponse>
{
    ...
    {
        var contract = await _contractRepository.GetContractAsync(request.Request.ContractId);
